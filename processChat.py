...
#########################################################################################
#
# Command line input to "clean" a raw chat.log file generated using the TwitchChatBot.
# The "cleaning" removes non-standard characters that are not recognized by Tensor Flow.
# A new file will be created with the "cleaned" chat.
#
#     Options:    - Produce clean text with Usernames and Messages
#
#                 - Produce clean text with only Messages
#
#########################################################################################
#########################################################################################
...
if __name__ == '__main__':
    ...
    logFile = input('\nInput chat.log file location:  ')

    chatText = input('\nInput name for clean chat.txt:  ')

    while True:
        users = input('\nInclude usernames? (Y/N)  ')
        if users == 'Y':
            clean_messages_with_users(logFile, chatText)
            break
        elif users == 'N':
            clean_messages(logFile, chatText)
            break
